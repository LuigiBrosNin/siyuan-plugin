...
const locales: Record<string, LocaleMap> = {
  fr: {
    ...
    'hint.encryption_password': 'Entrez un mot de passe pour activer le chiffrement côté client. NE le perdez PAS : sans lui les données ne pourront pas être déchiffrées.',
    'msg.password_forgot': 'Mot de passe de chiffrement effacé de la mémoire ; vous ne pourrez plus déchiffrer les données précédemment envoyées sans lui.',
    'part.the': 'le ',
    'part.and': ' et ',
    ...
    'error.token_invalid': '❌ Token GitHub invalide ou expiré. Va dans Paramètres -> générer un nouveau token.',
    ...
    'msg.pull_done': 'Pull terminé : {updated} fichiers mis à jour, {skipped} à jour ou protégés, {deleted} supprimé(s).',
  ...
  en: {
    ...
    'hint.encryption_password': 'Enter a password to enable client-side encryption. Do NOT lose it : without it data cannot be decrypted.',
    'msg.password_forgot': 'Encryption password cleared from memory; you will not be able to decrypt previously uploaded data without it.',
    'part.the': 'the ',
    'part.and': ' and ',
  ...
  zh: {
    ...
    'hint.encryption_password': '输入密码以启用客户端加密。请勿丢失，否则数据将无法解密。',
    'msg.password_forgot': '加密密码已从内存中清除。在不重新输入密码的情况下，将无法解密之前上传的数据。',
    'part.the': '',
    'part.and': ' 和 ',
    ...
    'notebook.prefix': '笔记本：',
    'msg.pull_done': '拉取完成：更新 {updated} 个，跳过 {skipped} 个，删除 {deleted} 个。',
